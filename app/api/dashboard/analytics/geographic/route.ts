...
import { getSellerGeographicAnalytics } from "@/lib/supabase-queries";

/**
 * GET /api/dashboard/analytics/geographic
 * Fetch geographic analytics data for seller
 *
 * Query Parameters:
...
export async function GET(request: NextRequest) {
  try {
    ...
    const geographicData = await getSellerGeographicAnalytics(
      user.id,
      timeRangeObj
    );
