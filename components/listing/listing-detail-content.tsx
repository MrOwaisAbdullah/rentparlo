...
export function ListingDetailContent({
  ...
  const getSellerMapUrl = () => {
    return (
      listing.seller?.profile?.map_location_url ||
  ...
  const transformSellerForContactModal = (): ContactModalSeller | null => {
    ...
    return {
      ...
      tier:
        listing.seller.profile?.tier === "diamond"
          ? "gold"
          : listing.seller.profile?.tier === "platinum"
            ? "gold"
            : listing.seller.profile?.tier === "gold"
              ? "gold"
              : listing.seller.profile?.tier === "silver"
                ? "premium"
                : listing.seller.profile?.tier === "bronze"
                  ? "premium"
                  : "basic",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-muted/20 border-b">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <Link
              href={`/category/${typeof listing.category?.slug === "string" ? listing.category.slug : listing.category?.slug?.current || listing.category?._id}`}
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {currentUser &&
          listing.supabaseId === currentUser.id &&
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <p>
                      This listing is currently in review and not visible to
                      other users. You can preview how it will look once
                      approved.
                    </p>
                    <p className="mt-1">
                      Status:{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="relative">
              <div className="aspect-[16/9] lg:aspect-[21/9] w-full relative overflow-hidden rounded-lg bg-muted">
                {listing.images && listing.images.length > 0 ? (
                  <Image
                    src={
                      listing.images[currentImageIndex]?.asset?.url ||
                      "/placeholder.svg"
                    }
                    alt={listing.title}
                    fill
            ...
            <div className="space-y-6">
              ...
              <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Badge
                        className={cn(
                          "text-xs",
                          conditionConfig[
                            listing.condition as keyof typeof conditionConfig
                ...
                {listing.seller?.profile?.tier && (
                  <div className="flex items-center gap-1">
                    <SellerTierBadge
                      tier={listing.seller.profile.tier}
                      points={listing.seller.profile.tier_points || 0}
                      size="sm"
                      variant="compact"
                    />
                  </div>
                ...
                {listing.seller ? (
                      ...
                      <div className="flex items-center gap-3 hover:opacity-80 transition-opacity relative z-0">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            <SellerTierBadge 
                              tier={listing.seller.profile?.tier || 'basic'}
                              points={listing.seller.profile?.tier_points || 0}
                              size="sm"
                              variant="compact"
                            />
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center text-sm">
                        <div>
                          <div className="font-semibold text-primary">
                            {listing.seller?.profile?.listing_count !== undefined 
                              ? listing.seller.profile.listing_count 
                        ...
                        <div className="font-semibold text-green-600">
                          {(() => {
                            if (listing.seller?.profile) {
                              const responseTimeInfo = calculateResponseTime(listing.seller.profile);
                              return responseTimeInfo.displayText;
                            }
                            return '< 1h';
                          })()}
                        </div>
                      ...
                      <div>
                        <div className="font-semibold text-yellow-500">
                          {listing.seller?.profile?.customer_rating?.toFixed(1) || 'N/A'}
                        </div>
                        <div className="text-muted-foreground">
                          ({listing.seller?.profile?.total_reviews || 0} reviews)
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="w-full">
                          {listing.seller?.phone && (
                            <WhatsAppButton
                              ...
                              sellerName={
                                listing.seller.profile?.business_name ||
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground text-sm mt-4">
                      This may be because the seller account has been deleted or
                      the listing data is incomplete.
                    </p>
                  </div>
                )}
              </CardContent>
      ...
      {showContactModal &&
        listing.seller &&
        transformSellerForContactModal() && (
          <ContactSellerModal
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={
                    !getSellerPhone() ||
                    listing.availability?.isAvailable === false
                  }
                >
