                      ...
                      <Avatar className="w-10 h-10">
                        <AvatarImage
                          src={
                            ...
                            `https://api.dicebear.com/7.x/initials/svg?seed=${review.userName || review.user?.name || review.user?.email || "Anonymous"}`
                          }
                        />
                        <AvatarFallback>
                          {(
